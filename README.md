...
Total Apps / Total Installs / Avg Rating
...
Market volume/competition per category
...
Which categories dominate user reach
...
Quality benchmark per category
...
Whether price correlates with rating
...
Hidden dissatisfaction despite decent ratings
...
Games (616bn) and Communication apps (451bn) dominate total installs, far ahead of every other category
...
Interactive file: dashboard.pbix — download and open in Power BI Desktop (free) to explore all filters and interactions



Static PDF export: dashboard_export.pdf
...
Note: A live Power BI Service shareable link isn't included, as publishing requires a work/school email domain. The .pbix file and PDF export provide full access to the dashboard and its design.
